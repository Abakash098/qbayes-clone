      ...
      <div className="max-w-[1240px] mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Future-Proof Your Business With <span className="text-blue-600">Our Intelligent AI Tech</span>
          </h2>
          ...
          <button className="bg-blue-600 text-white w-fit px-10 py-4 rounded-full font-bold hover:bg-blue-700 transition-all shadow-lg">
