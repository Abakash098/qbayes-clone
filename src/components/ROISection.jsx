  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-blue-50 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        {/* --- UPDATED BUTTON FOR ACCESS --- */}
        <button 
          onClick={scrollToBooking}
          className="bg-[#00c2ff] hover:bg-[#00a0d6] text-white px-10 py-4 rounded-full font-bold text-lg shadow-lg shadow-blue-400/30 transition-all flex items-center gap-2 mx-auto group active:scale-95"
        >
          Talk To Our Expert 
